...
MAIN_SOURCE = cmd/spurf/spurf.go
...
.PHONY: init
init:
	@curl --disable --silent --show-error --location --max-time 30 "https://raw.githubusercontent.com/ViBiOh/scripts/main/bootstrap" | bash -s "git_hooks" "coverage" "release" "var" "http"
